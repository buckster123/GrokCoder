...
TOOLS = [
    ...
    # NEW: Memory tools for hybrid hierarchy
    {
        "type": "function",
        "function": {
            "name": "memory_insert",
        ...
        while iteration < max_iterations:
            ...
            for tool_call in tool_calls:
                ...
                try:
                    ...
                    # NEW: Memory tools (use current user/convo_id; assume convo_id from session or auto-gen if new)
                    elif func_name == "memory_insert":
                        user = st.session_state['user']
                        convo_id = st.session_state.get('current_convo_id', 0)  # Track in session; set on new chat
